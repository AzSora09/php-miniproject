		...
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				if (isset($_GET['cat_id'])) {
					$id = $_GET['cat_id'];
					$query = mysqli_query($conn, "select * from products where cat_id=$id");
							...
							<div class="block2">
								...
								<div class="block2-txt flex-w flex-t p-t-14">
									<div class="block2-txt-child1 flex-col-l ">
										<a href="product-detail.php?pid=<?php echo $col["id"] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
											<?php echo $col["name"] ?>
										</a>

										<span class="stext-105 cl3">
											Rs. <?php echo $col["price"] ?>
										</span>
									</div>
