    ...
    <div class="container-fluid">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="submit" value="Add Category" name="catadd" class="btn btn-primary">
            </div>
        </form>
    </div>
    ...
    if (isset($_POST['catadd'])) {
        ...
        if ($exte == 'png' || $exte == 'jpg' || $exte == 'jpeg' || $exte == 'webp') {
            if (move_uploaded_file($cimgtmp, $destination)) {
                mysqli_query($conn, "insert into categories (name, description, img) values ('$cname', '$cdesc', '$cimgname')");
            }
